...
tf.app.flags.DEFINE_integer("batch_size", 3, "batch size")  # Normalmente 64
tf.app.flags.DEFINE_float("gamma", 100.0, "gamma param for latent loss")# 100 para beta, 1 para VAE
...
tf.app.flags.DEFINE_string("image_dir", "./58060.jpg", "image direction")
...
def train(sess,
    ...
    step = 0
    print("batch de ", flags.batch_size)
    # Training cycle
